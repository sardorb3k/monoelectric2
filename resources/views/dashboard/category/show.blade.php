    ...
    <div class="nk-block nk-block-lg">
        <div class="card card-bordered">
            <div class="card-inner">
                <form method="POST" action="{{ route('dashboard.category.update', $category->id) }}" class="form-validate"
                                ...
                                <div class="form-control-wrap">
                                    <div id="pagename_uz">
                                        <input type="text" class="form-control @error('title') error @enderror"
                                            value="{{ $category->name_en }}" id="page-name" name="name" required>
                                    </div>
                                </div>
                            </div>
                        </div>
