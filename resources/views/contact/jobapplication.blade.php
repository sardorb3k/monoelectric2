                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <form action="{{ route('jobs.form') }}" class="form-default" method="post"
                            ...
                            <div class="form-group">
                                <p>{{ __('contact.jobs_email') }}</p>
                                <input type="text" name="email" class="form-control"
                                    placeholder="{{ __('contact.jobs_email') }} *" required />
                            </div>
                            <div class="form-group">
                                <p>{{ __('contact.jobs_phone') }}</p>
                                <input type="text" name="phonenumber" class="form-control"
                                    placeholder="{{ __('contact.jobs_phone') }} *" required />
                            </div>
                            <div class="form-group">
                                <p>{{ __('contact.jobs_file') }}</p>
                                <input type="file" name="upload" class="form-control" required />
                            </div>
                            <div class="form-group">
                                <p>{{ __('contact.jobs_textarea') }}</p>
                                <textarea name="message" class="form-control" rows="4" placeholder="{{ __('contact.jobs_textarea') }} *" required></textarea>
                            </div>
                            {{-- <div class="form-group">
                            ...
                            @if (session('success') || session('error'))
                                <div class="alert @if (session('error')) alert-error @endif @if (session('success')) alert-success @endif shadow-lg">
                                    <div>
